...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('css/kaiadmin.min.css') }}" />
  ...
  <body>
        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                src="{{url('img/kaiadmin/logo_light.svg')}}"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
              ...
              <li class="nav-item active">
                ...
                <div class="collapse" id="dashboard">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{ url('/') }}">
                        <span class="sub-item">Peluquería</span>
                      </a>
                    </li>
                  </ul>
                  <ul class="nav nav-collapse">
    ...
    <!--   Core JS Files   -->
    <script src="{{ url('js/core/jquery-3.7.1.min.js') }}"></script>
